...
<br>
s4 : <form:input path="s4"/>
<form:errors path="s4"></form:errors>
<br>
s5 : <form:input path="s5"/>
<form:errors path="s5"></form:errors>
<br>
s6 : <form:input path="s6"/>
<form:errors path="s6"></form:errors>
<br>
s7 : <form:input path="s7"/>
<form:errors path="s7"></form:errors>
<br>
