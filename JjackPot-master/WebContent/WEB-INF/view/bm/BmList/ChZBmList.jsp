...
<jsp:include page="bm_sidebar.jsp" flush="false" />
	<div id="main-contents">
		<div class="con-header">
          ...
          <div class="table-search">
                    ...
                    <select name="searchColumn" title="검색타입">
                        <option value="emp_name" selected="selected">등록자  </option>
				...
				<thead >
                    <tr>
                        ...
                        <th style="width: 100px;">
                            <a data-sortcolumn="REGISTERNAME" href="#">등록자 <i class="fa fa-caret-up"><span class="blind">오름차순</span></i></a>
                        </th>
                        <th style="width: 120px;">
		...
		<tbody>
			...
			<c:forEach var="bmdto"  items="${ChZBGBmIjList}">
				<tr>
				...
				<table>
					<c:if test="${count > 0}">
						...
						<c:if test="${startPage > 10}">
							<a href="ChzBmList.jp?pageNum=${startPage-10}" >[이전]</a>
						</c:if>
			
						<c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
							<a href="ChzBmList..jp?pageNum=${i}" style="text-align: center; font-size: 13;">${i}&nbsp;</a>
						</c:forEach>
		
						<c:if test="${endPage < pageCount}">
							<a href="ChzBmList..jp?pageNum=${startPage+10}">[다음]</a>
						</c:if>
					</c:if>
				</table>
			</div>
	        ...
	        <div class="btn-wrap">
				<button type="button" class="btn btn-color5 br" onclick="window.location='bmForm.jp'">업무 등록</button>
     		   	<c:if test="${ bm_name == bmdto.bm_name } ">
